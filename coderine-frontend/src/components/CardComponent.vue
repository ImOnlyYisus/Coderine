        ...
        <figure class="card-component">
            ...
            <figcaption class="card-component--info">
                <div class="card-component--info__user">
                    <img :src="component.user.avatar" :alt="component.user.name" class="card-component--info__user--image">
                ...
                <img src="/images/logo-white.png" alt="Logo coderine" class="card-component--info__logo">
                <RouterLink :to="{
                    name: 'PlaygroundTemplate', params: { componentId: component.id, htmlTemplate: component.code, user: component.user.id }
                }">
                    <img src="/images/icons/edit.svg" alt="Modificar componente" class="card-component--info__edit">
                </RouterLink>
            </figcaption>
        </figure>
        <ChatCompoent :comments="component.comments" :component="component" @postComment="updateComments"></ChatCompoent>
    </div>
</template>
...
const likeComponent = () => {
    ...
    useComponentsStore().likeComponent(likeComponent)
        .then((component) => {
